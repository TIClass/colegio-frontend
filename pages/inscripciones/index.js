    ...
    <section>
      <section id='intensivo'>
        <Container fluid>
            ...
            <Row className='mt-5'>
              ...
              <Col md='4'>
                <Card style={{backgroundColor:'rgb(255,57,70)'}} className={styles["roundedbtn"]}>
                  <Card.Body>
      ...
      <section className='aprendizaje' style={{background:'white'}}>
        <Container className='text-center'>
          ...
          <br></br>
          <h3 className='text-center'>Colegio TIClass, aprendizaje <br></br> para todos</h3>
          <div style={{height:'3px',width:'100px',backgroundColor:'red',margin:'20px auto'}}></div>
          <Col md='12'>
            <Row>
              <Col md="6" className='text-center'>
                <Image src="/inscripciones/woman-2.png" alt="TIClass" width={473} height={618} style={{marginTop:'30px',marginTop:'-150px', marginLeft:'-20px'}}/>     
              </Col>
              <Col md="5" className='mt-5' style={{color:'#777', lineHeight:'28px',textAlign:'left'}}>
                <div className='ms-4'>
                  ...
                  <br></br>
                  <Button variant='warning' className={'text-white mt-4 '+styles["roundedbtn"]} 
      ...
      <section style={{background:'#f6f6f6'}}>
        <Container className='text-center'>
          ...
          <Row className='d-flex justify-content-center' style={{color:'#555'}}>
            <Col md="10">
              <Row>
                <Col md="4" className='my-5 d-flex align-items-center'>
                  <Image src="/inscripciones/libro.png" alt="TIClass" width={60} height={60} className='my-4 me-2'/>     
                  <span className='me-0' style={{display:'block', textAlign:'left'}}>
